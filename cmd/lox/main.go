...
func realMain() error {
	...
	agrammar.Print(os.Stdout)
	pt := lr1.ConstructLR(agrammar)
	pt.Print(os.Stdout)

	codegenState, err := codegen.Parse(dir)
	if err != nil {
		return err
	}
...
func parseGrammar(dir string) (*grammar.Grammar, error) {
